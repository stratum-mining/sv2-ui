...
`sv2-ui` uses `stratumv2/translator_sv2:v0.6.0` for no-JD stacks. JD stacks use `stratumv2/jd_client_sv2:v0.6.0` and `stratumv2/translator_sv2:v0.6.0`.
