...
`sv2-ui` uses `stratumv2/translator_sv2:v0.5.0` for no-JD stacks. JD stacks select JDC and Translator Proxy images from the Bitcoin Core compatibility table.

This release pins all sv2-apps image tags in `shared/src/images.ts`.
...
| 31.0 | `stratumv2/jd_client_sv2:v0.5.0` | `stratumv2/translator_sv2:v0.5.0` | Supported | [`release/v0.3.0`](https://github.com/stratum-mining/sv2-ui/tree/release/v0.3.0) |
