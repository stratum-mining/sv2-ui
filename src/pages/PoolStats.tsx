...
export function PoolStats() {
  ...
  const stats = useMemo(() => {
    ...
    // Total shares submitted (last_share_sequence_number)
    const extSubmitted = poolChannels.extended_channels.reduce((sum, ch) => sum + ch.last_share_sequence_number, 0);
    const stdSubmitted = poolChannels.standard_channels.reduce((sum, ch) => sum + ch.last_share_sequence_number, 0);
    ...
    return {
      ...
      sharesSubmitted: extSubmitted + stdSubmitted,
  ...
  return (
    <Shell appMode="translator" appName="SV2 Mining Stack">
